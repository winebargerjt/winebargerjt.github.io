...
```{r}
knitr::include_app("https://illenyekd.shinyapps.io/TwoYears/", height = "300px")
```
...
```{r}
knitr::include_app("https://illenyekd.shinyapps.io/boxplots/", height = "300px")
```
...
```{r}
knitr::include_app("https://illenyekd.shinyapps.io/twoDays/", height = "300px")
```
...
```{r}
knitr::include_app("https://illenyekd.shinyapps.io/annualAVG/", height = "300px")
```
